    ...
    return (
        <motion.div initial='hidden' animate='visible' className='flex flex-row items-center justify-center px-20 mt-40 w-full z-[20] '>
            <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
                ...
                >
                    I&apos;m a Front End Developer with in website,
                    Mobile. Check out my Projects and Skills.
                </motion.p>
                <motion.a variants={slideInFromLeft(1)}
                    className='py-2 button-primary text-white text-center cursor-pointer rounded-lg max-w-[200px]'
                >
                    Learn More
                </motion.a>
            </div>
            <motion.div variants={slideInFromRight(0.8)}
                ...
                <Image src='/mainIconsdark.svg' alt='Work Icon' height={650} width={650} priority={true} />
            </motion.div>
